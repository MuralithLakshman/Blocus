...
Home* new_home(Sprites* sprites_manager) {
  ...
  home->one_player_sprite = load_sprite("assets/1-Player.png", sprites_manager);
  home->two_players_sprite = load_sprite("assets/2-Players.png", sprites_manager);
  home->one_player_selected_sprite = load_sprite("assets/1-Player-green.png", sprites_manager);
  home->two_players_selected_sprite = load_sprite("assets/2-Players-green.png", sprites_manager);
...
int mouse_click_home(Home* home) {
  ...
  if(SourisCliquee()) {
    ...
    printf("x = %d, y = %d\n", x, y);
    printf("Grid Size = %d\n", home->grid_size); 
    printf("Button : x = %d, y = %d, width = %d, height = %d\n", home->up_button.x, home->up_button.y, home->up_button.width, home->up_button.height);
